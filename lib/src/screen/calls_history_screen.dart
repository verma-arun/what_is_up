...
import 'package:what_is_up/src/model/call_details_model.dart';
import 'package:what_is_up/src/model/call_model.dart';
import 'package:what_is_up/src/theme/colors.dart';

enum CallDetailOptions { removeLog, block }

class CallHistoryScreen extends StatefulWidget {
  _CallHistoryScreen createState() => _CallHistoryScreen();
}
...
class _CallHistoryScreen extends State<CallHistoryScreen> {
            ...
            child: Column(
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: Text(
                    DateFormat.yMMMd().format(call.lastCall.timestamp),
                    style: TextStyle(
                      fontSize: 16.0,
  ...
  Widget _buildCallDetails(CallModel call) {
    List<Widget> callDetails = new List<Widget>();

    for (CallDetail detail in call.callDetail.reversed.toList()) {
